...
ActiveRecord::Schema[7.0].define(version: 2022_06_09_145943) do
  ...
  create_table "ingredients_posts", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
